...
## Описание проекта
MovieRate — это веб-приложение для публикации отзывов и оценок фильмов.  
Пользователи могут просматривать список фильмов, оставлять отзывы, ставить оценки и читать отзывы других пользователей.

Проект реализован по клиент-серверной архитектуре и состоит из backend и frontend частей.
